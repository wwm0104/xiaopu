...
function initPartnerData(page, row) {
    ...
    $.ajax({
        processData: false,
        type: 'POST',
        url: "/partnerManage/getGroupPartner",
        ...
        success: function (data) {
            ...
            $.each(data.obj.list, function (i, partner) {
                    tdHtml += "<tr>";
                    tdHtml += "<td><a style='color: black;' href='/partnerManage/groupDetails/"+partner.groupId+"'>" + partner.groupName + "</a></td>";
                    tdHtml += "<td><a style='color: black;' href='/partnerManage/groupDetails/"+partner.groupId+"'>" + partner.schoolName + "</a></td>";
                    tdHtml += "<td><a style='color: black;' href='/partnerManage/groupDetails/"+partner.groupId+"'>" + partner.realName + "</a></td>";
                    tdHtml += "<td><a style='color: black;' href='/partnerManage/groupDetails/"+partner.groupId+"'>" + partner.mobile + "</a></td>";
                    tdHtml += "<td><a style='color: black;' href='/partnerManage/groupDetails/"+partner.groupId+"'>" + partner.joinTime + "</a></td>";
                    tdHtml += "<td><a style='color: black;' href='/partnerManage/groupDetails/"+partner.groupId+"'>" + partner.checkTime + "</a></td>";
                    ...
                    tdHtml += "<td><a style='color: black;' href='/partnerManage/groupDetails/"+partner.groupId+"'>" + partner.remarks + "</a></td>";
                    tdHtml += "</tr>";
