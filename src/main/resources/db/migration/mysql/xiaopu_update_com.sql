/*
 ...
 Source Server         : chainxiaopu_top
 Source Server Type    : MySQL
 Source Server Version : 50714
 Source Host           : api.chinaxiaopu.top
...
-- ----------------------------
--  Table structure for `banner_imgs`
-- ----------------------------
DROP TABLE IF EXISTS `banner_imgs`;
...
CREATE TABLE `pk_prize_result` (
  ...
  `code` varchar(36) DEFAULT NULL COMMENT '奖品编码',
...
CREATE TABLE `pk_prize_take_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='预付奖品物资，每增加一个PK，库存出库+1（针对实物类）';
...
CREATE TABLE `prizes_imprest` (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='预占位奖品物资，每增加一个PK，库存出库+1（针对实物类）';
...
-- ----------------------------
--  Table structure for `recommend_index`
-- ----------------------------
DROP TABLE IF EXISTS `recommend_index`;
CREATE TABLE `recommend_index` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `topic_id` int(11) NOT NULL,
  `sort` tinyint(255) NOT NULL,
  `recommend_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `parent_type` int(11) NOT NULL DEFAULT '0' COMMENT 'parent_type = 0 : 首页pk主题',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tipoffs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tipoff_id` int(11) NOT NULL,
  `tipoff_type` tinyint(1) NOT NULL DEFAULT '1' COMMENT '举报类型: 1:帖子举报，2：活动举报，3：社团举报。',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='热门主题，当天数据，100条这里取';
...
CREATE TABLE `topic_like` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='点赞无取消点赞功能';
...
CREATE TABLE `topic_new` (
  ...
  PRIMARY KEY (`topic_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='最新主题,前50条这里取，后续数据从主表取得';
...
CREATE TABLE `topic_pk` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='PK定义表';
...
CREATE TABLE `topics` (
  ...
  `update_time` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间，计数变化需要更新计数时间',
